...
class InventarioServiceTest {
    ...
    void productoEsCorrecto_relacionValida() {
        assertTrue(inventarioService.productoEsCorrecto(inventario, 10L));
        assertFalse(inventarioService.productoEsCorrecto(inventario, 99L));
    }
    ...
    @Test
    @DisplayName("findByProductoId retorna los movimientos del producto")
